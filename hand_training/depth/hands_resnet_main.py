...
def main(_):
    ...
    if FLAGS.hand == "right":
        FLAGS.log_root = "/s/red/a/nobackup/cwc/tf/chalearn/depth/RH"
        FLAGS.train_dir = "/s/red/a/nobackup/cwc/tf/chalearn/depth/RH/train"

    elif FLAGS.hand == "left":
        FLAGS.log_root = "/s/red/a/nobackup/cwc/tf/chalearn/depth/LH"
        FLAGS.train_dir = "/s/red/a/nobackup/cwc/tf/chalearn/depth/LH/train"
    else:
        return
