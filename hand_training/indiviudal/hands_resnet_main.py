...
def main(_):
    ...
    if FLAGS.hand == "right":
        FLAGS.log_root = "/s/red/a/nobackup/cwc/tf/chalearn/individual/RH"
        FLAGS.train_dir = "/s/red/a/nobackup/cwc/tf/chalearn/individual/RH/train"

    elif FLAGS.hand == "left":
        FLAGS.log_root = "/s/red/a/nobackup/cwc/tf/chalearn/individual/LH"
        FLAGS.train_dir = "/s/red/a/nobackup/cwc/tf/chalearn/individual/LH/train"
    else:
        return
