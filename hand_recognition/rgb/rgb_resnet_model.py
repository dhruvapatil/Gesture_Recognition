...
class ResNet(object):
    ...
    def __init__(self, hps, mode,width, height):
        """ResNet constructor.
        Args:
          hps: Hyperparameters.
        ...
        """
        self.hps = hps
        self._images = tf.placeholder(tf.float32, [None, width,height, 3])
        self.labels = tf.placeholder(tf.float32, [None, hps.num_classes])
        self.mode = mode
