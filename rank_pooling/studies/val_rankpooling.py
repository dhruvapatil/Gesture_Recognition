...
if __name__ == "__main__":
    ...
    extract_rank_pooling_features_inter(main_folder, des_folder, list_index, category='val', velocity=True, approach='normal')
    ...
    #generate_features_and_filenames(des_folder, '../index_log_files/inter_val_feature_and_filename.npy', approach='combined', category='val', velocity_flag=True)
    #generate_features_and_labels('../index_log_files/inter_val_feature_and_filename.npy', 'val', '../index_log_files/features_val.npy', '../index_log_files/labels_val.npy')